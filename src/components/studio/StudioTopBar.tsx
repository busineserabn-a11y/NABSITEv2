...
export const StudioTopBar: React.FC<StudioTopBarProps> = ({
  ...
  return (
    <header className="h-16 bg-slate-900 border-b border-slate-800 px-3 sm:px-5 flex items-center justify-between gap-3 shrink-0 text-white z-30 select-none">
      {/* Left: Exit to dashboard & Company info & Page selector */}
        ...
        <div className="flex items-center gap-2.5 min-w-0">
          <div className="min-w-0 hidden sm:block">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs font-bold text-slate-200 truncate">
                <CompanyName name={company.name} maxWidth="max-w-[140px] sm:max-w-[200px]" />
              </span>
            </div>
          </div>
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-800/90 hover:bg-slate-700 border border-slate-700 text-xs font-bold text-amber-300 transition-colors"
            >
              <Layers className="w-3.5 h-3.5 text-amber-400" />
              <span>Editing: {activePage.name || 'Home'}</span>
      ...
      <div className="hidden md:flex items-center gap-1 bg-slate-950 p-1 rounded-2xl border border-slate-800">
        <button
          type="button"
      ...
      {/* Right: Status, Preview, Save Draft & Publish */}
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          onClick={onSaveDraft}
          disabled={isSaving}
          className="px-3.5 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-white text-xs font-bold flex items-center gap-1.5 transition-colors disabled:opacity-50"
        >
        ...
        <button
          ...
          className="px-4 py-1.5 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 text-xs font-black flex items-center gap-1.5 shadow-lg shadow-amber-500/20 transition-all active:scale-95 disabled:opacity-50"
        >
